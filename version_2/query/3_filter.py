...
# ==========================================
QUERY_RESULTS_FILE = "./version_2/query/2_output.json"
GRAPH_DATA_FILE = "./version_2/1.1_output_data_for_graph.json"
OUTPUT_FILE = "./version_2/query/3_filtered_triplets.json"
