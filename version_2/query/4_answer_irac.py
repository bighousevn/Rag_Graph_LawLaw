...
QUESTION_FILE = "./version_2/query/1_question.json"
FILTERED_TRIPLETS_FILE = "./version_2/query/3_filtered_triplets.json"
SENTENCES_FILE = "./version_2/1_input_sentences.json"
OUTPUT_FILE = "./version_2/query/4_result.json"
