...
def main():
    ...
    # Đường dẫn file
    input_filepath = "./version_2/3_synonyms_formatted.json"
    output_filepath = "./version_2/4_synonyms_with_vectors.json"
    ...
    # Chúng ta ưu tiên vector hóa trường 'synonym' vì đây là từ khóa người dùng có thể nhập vào
    texts_to_encode = [item["synonym"] for item in data]
