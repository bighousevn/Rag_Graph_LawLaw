...
Ví dụ few-shot:
Input:  "Cá nhân, tổ chức vi phạm hành chính ... phải chịu hình thức xử phạt chính là phạt tiền."
Output: {"results": {"<id>": ["Cá nhân và tổ chức vi phạm hành chính ... phải chịu hình thức xử phạt chính là phạt tiền."]}}
...
Output: {"results": {"<id>": ["Người điều khiển xe ô tô tải, máy kéo và các loại xe tương tự xe ô tô vận chuyển hàng hóa chở hàng vượt quá khối lượng cho phép bị phạt tiền."]}}
