...
(Người, Đi vào, Đường có biển báo cấm)
  →  (Người, Đi vào, Đường), (Đường, Có, Biển báo cấm)
...
(Người, Giữ, Khoảng cách an toàn giữa hai xe)
  →  (Người, Giữ, Khoảng cách an toàn)   [bỏ phần "giữa hai xe" nếu chỉ là chi tiết bổ sung không
